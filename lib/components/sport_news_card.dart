...
class SportNewsCard extends StatefulWidget {
  SportNewsCard();

  @override
  State<SportNewsCard> createState() => _SportNewsCardState();
}

class _SportNewsCardState extends State<SportNewsCard> {
  @override
  Widget build(BuildContext context) {
    return FutureBuilder<List<Articles>>(
      future: NewsApiController.newsApiController.readNewsSports(),
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          Provider.of<ApiProvider>(context, listen: false).newsListSport =
              snapshot.data!;
