...
class HealthNewsTitle extends StatefulWidget {
  HealthNewsTitle({Key? key}) : super(key: key);

  @override
  State<HealthNewsTitle> createState() => _HealthNewsTitleState();
}

class _HealthNewsTitleState extends State<HealthNewsTitle> {
  @override
  Widget build(BuildContext context) {
    return FutureBuilder<List<Articles>>(
      future: NewsApiController.newsApiController.readNewsHealth(),
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          Provider.of<ApiProvider>(context, listen: false).newsListHealth =
              snapshot.data!;
          return SizedBox(
            height: 500,
